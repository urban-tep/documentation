...
Users applying to become expert users are assumed to be registered with ESA EO SSO. They use the corresponding form in "Develop and offer content" of the portal. Submitting the form creates an issue in the ticket handling system.
...
* The portal operator associates the user with the (closed) community.
