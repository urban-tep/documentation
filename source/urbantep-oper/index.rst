...
The Urban TEP operational procedures are instructions for the operators of the system. They describe the steps to be performed for partially automated workflows initiated by users. Usually, they involve the user relationship management system (issue tracking) to trace the communication between user, help desk, and the operators of portal, processing centres, and visualisation and analysis tool. In some cases government of the Urban TEP is involved as well.
